---
title: "COMPASS_TEMPEST_SGW_2023: September"
...
#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_SGW_202309.csv")
head(raw)
...
Slopes$Run_Date <- c(202309, 202309, 202309)

log <- read.csv("Raw Data/COMPASS_Varian_QAQC_2023.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "Raw Data/COMPASS_Varian_QAQC_2023.csv")
```
...
write.csv(alldat, "Processed Data/COMPASS_CBSYN_SGW_202309_Processed.csv")
