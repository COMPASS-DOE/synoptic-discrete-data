...
#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_SGW_202305.csv")
head(raw)
...
Slopes$Run_Date <- c(202305, 202305, 202305)
...
write.csv(alldat, "Processed Data/COMPASS_CBSYN_SGW_202305_Processed.csv")
