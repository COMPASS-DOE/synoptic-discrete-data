---
title: "COMPASS_TEMPEST_SGW_2024: August"
...
## Read in data file and assess standard curves 
```{r , echo=FALSE}

#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_SGW_202408_entered.csv")
head(raw)
...
Slopes$Run_Date <- c(202408, 202408, 202408)

log <- read.csv("Raw Data/COMPASS_Varian_QAQC_2024.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "Raw Data/COMPASS_Varian_QAQC_2024.csv")
```
...
## If samples are water calculate gas in water - only need if there is water 
```{r, echo=FALSE}
...
write.csv(alldat, "Processed Data/COMPASS_CBSYN_SGW_202408_Processed.csv")
