...
# Save as a PNG
png("Figures/COMPASS_SynopticCB_Redox_alldata.png", width = 2000, height = 1200, res = 100) 
...
save_kable(summary_table, file = "Figures/COMPASS_SynopticCB_Redox_Summary_alldata.png", 
           zoom=2)

#Print the PNG
knitr::include_graphics("Figures/COMPASS_SynopticCB_Redox_Summary_alldata.png")
