...
Wilson S ; Chin, N ; Phillips E ; Read Z ; Stearns A ; Bailey V ; Megonigal J P (20XX): COMPASS-FME Synoptic Site Soil Redox Profiles (Manual Redox Probe). COMPASS-FME, ESS-DIVE repository. Dataset. doi:TBD accessed via Link TBD.
...
"COMPASS_SynopticCB_Redox_DataDictionary.csv" = Metadata / Data dictionary for AllData file that defines each column header, units, and instrumentation.
...
![Figure 1: Experimental design ](Figures/REDOX_Image_3.png) 
...
![Figure 2a: REDOX Probes inserted for sampling ](Figures/REDOX_Image_1.png)
![Figure 2b: REDOX Probes inserted for sampling ](Figures/REDOX_Image_2.png)
