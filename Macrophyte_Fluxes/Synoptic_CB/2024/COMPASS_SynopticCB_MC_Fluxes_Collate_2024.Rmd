...
hydrago <- read.csv("S:/Biogeochemistry/COMPASS Synoptics/Samples & Data/Soil Conductivity Probe/Raw Data Files/2024/COMPASS_Synoptic_2024_ALL_SoilCond_Data.csv")
...
write.csv(missing_ids, "fluxes_missing_hydrago_data_2024.csv", row.names = FALSE)
...
files <- files[
  ...
  grepl("2024", files, ignore.case = TRUE) &
...
#Poor/messy flux
messy <- all_dat %>% 
  filter(grepl("messy", ch4_qaqc_flag, ignore.case = TRUE) | grepl("Unusual", ch4_qaqc_flag, ignore.case = TRUE) | grepl("poor", co2_qaqc_flag, ignore.case = TRUE))
...
write.csv(final_dat, "COMPASS_SynopticCB_MC_Fluxes_2024.csv")
