...
low <- quantile(fluxes$flux_estimate, 0.05) 
high <- quantile(fluxes$flux_estimate, 0.95) 
...
write.csv(allflux, file="Processed Data/COMPASS_Synoptic_CB_Macrophyte_Fluxes_Final_2022.csv")           #Change file name
