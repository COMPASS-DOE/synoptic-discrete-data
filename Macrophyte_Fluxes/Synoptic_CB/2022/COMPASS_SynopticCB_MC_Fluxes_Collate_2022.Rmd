...
hydrago <- read.csv("S:/Biogeochemistry/COMPASS Synoptics/Samples & Data/Soil Conductivity Probe/Raw Data Files/2022/COMPASS_Synoptic_2022_ALL_SoilCond_Data.csv")
...
write.csv(missing_ids, "fluxes_missing_hydrago_data_2022.csv", row.names = FALSE)
...
write.csv(final_dat, "COMPASS_SynopticCB_MC_Fluxes_2022.csv")
