...
#read in data 
file1 <- read.csv("SEAL_COMPASS_Synoptic_NH3_PO4_Aug2022_1.csv")
...
#read in data 
file2 <- read.csv("SEAL_COMPASS_Synoptic_NH3_PO4_Aug2022_2.csv")
#Quick look at dataframe
head(file2)
#take out only the columns that we need 
...
#read in data 
file3 <- read.csv("SEAL_COMPASS_Synoptic_NH3_PO4_Aug2022_3.csv")
#Quick look at dataframe
head(file3)
#take out only the columns that we need 
...
#read in data 
Nfile1 <- read.csv("SEAL_COMPASS_Synoptic_NOx_Aug2022_1.csv")
#Quick look at dataframe
head(Nfile1)
#take out only the columns that we need 
...
#read in data 
Nfile2 <- read.csv("SEAL_COMPASS_Synoptic_NOx_Aug2022_2.csv")
#Quick look at dataframe
head(Nfile2)
#take out only the columns that we need 
...
#read in data 
Nfile3 <- read.csv("SEAL_COMPASS_Synoptic_NOx_Aug2022_3.csv")
#Quick look at dataframe
head(Nfile3)
#take out only the columns that we need 
...
write.csv(alldat, file="COMPASS_Synoptic_CB_SEAL_NUTR_Aug2022.csv")
