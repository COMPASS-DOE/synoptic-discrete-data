...
allflux_cols <- allflux_filtered[,-c(31:33)]

#export as a csv to the folder that you want 
write.csv(allflux_cols, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2022_CO2.csv")           #Change file name
