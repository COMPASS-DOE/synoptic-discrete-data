...
tobechecked <- c("1_May_MSM_UP_2", "1_Oct_GWI_TR_1")
...
fixedplots <- c("1_Jul_GWI_TR_1a" , "2_Sep_MSM_TR_4", "1_May_MSM_UP_2", "1_Oct_GWI_TR_1")
...
# ### pull all fluxes to check and plot
...
allflux_cols <- allflux_filtered[,-c(34:36)]

#fix TIMESTAMP format
allflux_cols$TIMESTAMP <- format(allflux_cols$TIMESTAMP, format = "%Y-%m-%d %H:%M:%S")

#export as a csv to the folder that you want 
write.csv(allflux_cols, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2022_CO2.csv", row.names = FALSE)           #Change file name
