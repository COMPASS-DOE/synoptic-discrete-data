...
allflux_filtered <- allflux_filtered[,-c(34:36)]

#fix TIMESTAMP format
allflux_filtered$TIMESTAMP <- format(allflux_filtered$TIMESTAMP, format = "%Y-%m-%d %H:%M:%S")

#export as a csv to the folder that you want 
write.csv(allflux_filtered, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2022_CH4.csv", row.names = FALSE)           #Change file name
