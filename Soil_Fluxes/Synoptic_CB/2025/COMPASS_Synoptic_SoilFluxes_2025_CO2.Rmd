---
title: "COMPASS_Synoptic_SmartChamberFluxes_2025_CO2"
...
eb_flags <- c("2-Mar-GWI-TR-2", "2-Mar-GWI-TR-4")
...
allflux <- allflux %>%
    mutate(qaqc_flag = ifelse(is.na(qaqc_flag) & Plot %in% neg_plots, "negative CO2 flux, messy - remove", qaqc_flag))
...
allflux_final <- cbind(IDs, allflux_filtered)

#export as a csv to the folder that you want 
write.csv(allflux_final, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2025_CO2.csv", row.names = FALSE)           #Change file name
