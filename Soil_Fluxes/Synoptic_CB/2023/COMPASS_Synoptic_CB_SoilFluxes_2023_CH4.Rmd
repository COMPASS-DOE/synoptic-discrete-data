...
allflux1 <- left_join(fluxes, soildat, by = "Plot")
...
tobechecked <- c(
"2-May-SWH-TR-8", "1-Aug-SWH-TR-10a", "2-Jul-SWH-TR-9", "1-Jul-SWH-TR-9", "1-May-GCW-TR-3", 
                      "2-May-GCW-TR-3", "1-Aug-SWH-TR-9", "1-Aug-GCW-TR-2"
)
...
fixedplots <- c("2-Aug-GWI-TR-3", "2-Sep-SWH-UPCON-1", "2-Sep-MSM-TR-3" ,"2-Sep-MSM-TR-1", "1-May-SWH-UP-2",
                ...
                "1-Sep-SWH-TR-9a", "2-Sep-GCW-TR-5", "2-Nov-SWH-UPCON-3", "1-Jun-GCW-TR-5", "1-Jul-GCW-TR-3", 
                "2-Jul-GCW-TR-3", "1-Apr-GCW-TR-4", "1-Aug-GCW-TR-2", "1-May-SWH-TR-7", "1-Aug-SWH-TR-9" , 
                "2-Jul-SWH-TR-9", "1-May-GCW-TR-3", "2-May-GCW-TR-3", "2-May-GCW-TR-5", "2-May-SWH-UP-1", 
                "1-Aug-SWH-UP-1a", "1-Apr-GCW-TR-2", "1-Aug-SWH-TR-9", "1-Aug-SWH-UP-2", "1-Jul-GWI-TR-1", 
                "1-Jun-GCW-TR-2", "2-Sep-SWH-TR-3", "2-Sep-GCW-TR-1", "1-Jul-SWH-TR-2", "1-May-SWH-UP-1", 
                "2-Oct-GCW-TR-3", "1-Apr-GCW-TR-2", "1-Aug-SWH-UP-2", "2-Sep-SWH-TR-5a")
...
allflux_filtered <- allflux_filtered %>%
  filter(!Plot %in% c("2-May-SWH-TR-8", "1-Aug-SWH-TR-10a", "2-Jul-SWH-TR-9", "1-Jul-SWH-TR-9", "1-May-GCW-TR-3", 
                      "2-May-GCW-TR-3", "1-Aug-SWH-TR-9", "1-Aug-GCW-TR-2")) 
          #these GCW ones look fine but are way higher than expected
          #the SWH ones are ugllllyyyy 

# 2-May-SWH-TR-8, weird looking flux
# 1-Aug-SWH-TR-10a, weird looking flux
# 1-Aug-SWH-TR-9, upside down V
# 1-Aug-GCW-TR-2, upside down V
# Other fluxes are off because the CH4 values are crazy high
...
write.csv(allflux_filtered, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2023_CH4.csv", row.names = FALSE)           #Change file name
