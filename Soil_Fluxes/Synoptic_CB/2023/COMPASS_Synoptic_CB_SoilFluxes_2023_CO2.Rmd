...
allflux_filtered <- allflux_filtered %>%
  filter(!Plot %in% c("2-Jul-SWH-TR-9", "1-Jul-SWH-TR-9", "1-May-GCW-TR-3", "2-May-GCW-TR-3", "1-Aug-SWH-TR-10a", "1-Sep-GCW-UP-3", "2-Jul-SWH-TR-9", "2-May-SWH-UP-1")) 

# 1-Aug-SWH-TR-10a, V-shaped
# 1-Sep-GCW-UP-3, V-shaped
# 2-Jul-SWH-TR-9, has a starting CO2 value of over 30,000
# 2-May-SWH-UP-1, has a high flux but all over the place
