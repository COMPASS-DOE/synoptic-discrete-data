...
#alldat$Drop <- metadata$Drop[alldat$metadat_row] #don't need this for now because we remove the fluxes that were retaken above 
...
fixedplots <- c("2-Jul-GWI-UP-3", "2-Aug-SWH-TR-6a", "1-Oct-SWH-TR-9", "1-Sep-SWH-TR-9",
                ...
                "2-May-SWH-TR-6a", "2-Sep-SWH-TR-1a", "1-Jul-SWH-TR-9d", "2-Jul-SWH-TR-9d", "1-Jul-SWH-TR-9d", "1-May-GCW-TR-3a", 
                "2-May-GCW-TR-3", "1-Aug-SWH-TR-10a", "1-Sep-GCW-UP-3")
...
eb_flags <- c("2-Nov-SWH-TR-9a", "1-Nov-SWH-TR-9a", "2-Sep-SWH-TR-7a", "2-Sep-SWH-TR-7a", 
              ...
              "2-Aug-SWH-TR-8a", "1-Oct-SWH-TR-8a", "1-Apr-GCW-UP-2")
...
#Any others that are not in the weird category that need to be removed: 
  #also flagging ones that are crazy off but were not in the fluxes_weird dataframe (did this by listing them below)


########## Poor fluxes

#List the ones that are w-shaped - assessed visually for now 
poor_flags <- c("2-Jul-SWH-TR-9d", "1-Jul-SWH-TR-7b")
...
write.csv(allflux_filtered, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2024_CO2.csv", row.names = FALSE)           #Change file name
