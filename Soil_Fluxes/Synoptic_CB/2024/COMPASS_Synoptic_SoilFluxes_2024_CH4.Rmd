...
#Tell the code where to find raw data in the project
setwd("Raw Data/")

#create a list of all the files in the raw data folder (json raw smart chamber files)
...
fluxes_weird <- as.data.frame(subset(allflux, lin_r.squared < .90 & lin_flux.estimate > 5, select = Plot:TIMESTAMP_max))
...
tobechecked <- c("2-May-SWH-TR-6a", "2-Sep-SWH-TR-1a"  , "2-Oct-SWH-TR-8a", "2-May-SWH-UP-5" , "1-May-MSM-TR-1a", "1-May-GWI-TR-1b", "1-Jul-MSM-TR-4" ,
