...
##Soil probe not working for Apr - July? , set soilp_c and soilp_m to NA
months_no_probe = c("Apr", "May", "Jun", "Jul")
pattern <- paste(months_no_probe, collapse = "|")

soildat <- soildat %>%
  mutate(soilp_c = ifelse(str_detect(Plot, pattern), NA, soilp_c),
         soilp_m = ifelse(str_detect(Plot, pattern), NA, soilp_m))
...
fixedplots <- c("2-Jul-GWI-UP-3", "2-Aug-SWH-TR-6a", "1-Oct-SWH-TR-9", "1-Sep-SWH-TR-9",
                ...
                "2-May-SWH-TR-6a", "2-Sep-SWH-TR-1a"  , "2-Oct-SWH-TR-8a", "2-May-SWH-UP-5" , "1-May-MSM-TR-1a", "1-May-GWI-TR-1b", "1-Jul-MSM-TR-4" ,
                 "1-Aug-SWH-UP-1a", "1-May-GCW-TR-3a", "1-May-SWH-SWAMP-1a", 
                "2-Oct-SWH-TR-8a", "2-Jun-SWH-TR-8b", "2-Sep-SWH-SWAMP-5", "2-Jun-SWH-TR-4" ,"1-Sep-SWH-SWAMP-2" , "1-Sep-SWH-TR-4a" , "2-Jun-SWH-TR-7b" ,
                "2-Nov-SWH-SWAMP-5a", "2-Oct-SWH-SWAMP-5a" , "2-May-GCW-TR-1" , "1-Sep-SWH-TR-10", 
                "1-Aug-SWH-SWAMP-2", "1-Jul-SWH-TR-5", "1-Jun-SWH-TR-1a", "1-Jun-SWH-TR-8b", "1-May-GCW-TR-4", "1-May-SWH-SWAMP-2", "1-May-SWH-TR-4a", 
                "1-Nov-SWH-SWAMP-1", "1-Nov-SWH-SWAMP-2a", "1-Oct-SWH-SWAMP-3a", "1-Sep-SWH-TR-7a", "1-Sep-SWH-TR-8b", "2-Aug-SWH-SWAMP-2", 
                "2-Aug-SWH-TR-1", "2-May-SWH-SWAMP-2", "2-Nov-SWH-SWAMP-1", "2-Nov-SWH-TR-9a", "2-Oct-SWH-SWAMP-2", "2-Oct-SWH-SWAMP-3a", 
                "1-Aug-GWI-TR-3", "2-Nov-SWH-TR-8"
)
...
## Take a look at the bad fluxes <0.9 and have a high flux estimate (>5) 
...
eb_flags <- c("2-Nov-SWH-TR-9a", "1-Nov-SWH-TR-9a", "2-Sep-SWH-TR-7a", "2-Sep-SWH-TR-7a", 
              ...
              "2-May-SWH-UP-5", "1-May-MSM-TR-1a", "1-Jul-MSM-TR-4", 
              "2-Jul-SWH-TR-9d", "2-Sep-SWH-TR-7a", "2-Nov-SWH-TR-9a")


#add a flag for the fluxes that have ebullition and therefore not even a flux 
allflux <- allflux %>%
    mutate(qaqc_flag = ifelse(is.na(qaqc_flag) & Plot %in% eb_flags, "significant ebullition, flux compromised, remove", qaqc_flag))
...
##Remove test samples
plots_to_remove <- c("1-Jun-04", "1-Aug-Test2")
allflux_filtered <- allflux[!(allflux$Plot %in% plots_to_remove), ]


########## Poor fluxes

#List the ones that have odd/poor flux shapes - assessed visually for now 
poor_flags <- c("2-Oct-SWH-TR-8a", "1-Jul-SWH-TR-9d", "1-Jul-SWH-TR-7b", 
                "1-Nov-SWH-TR-9a", "1-Nov-SWH-TR-5a", "1-Oct-SWH-SWAMP-1a", 
                "1-Oct-SWH-TR-8a", "2-Aug-SWH-TR-8a", "2-Nov-SWH-TR-4a", 
                "2-Jul-SWH-TR-9d", "2-Nov-SWH-TR-9a", "2-Sep-SWH-TR-7a"
                )

#add a flag for the fluxes that are v-shaped and therefore not even a flux 
allflux_filtered <- allflux_filtered %>%
    mutate(qaqc_flag = ifelse(is.na(qaqc_flag) & Plot %in% poor_flags, "poor flux, remove", qaqc_flag))


# 2-Oct-SWH-TR-8a - poor flux, remove
# 1-Jul-SWH-TR-9d - poor flux, remove
# 1-Jul-SWH-TR-7b - poor flux, remove
# 1-Nov-SWH-TR-9a - poor flux, remove
# 1-Nov-SWH-TR-5a - poor flux, remove
# 1-Oct-SWH-SWAMP-1a - L-shaped, high CH4, remove
# 1-Oct-SWH-TR-8a - U-shaped, remove
# 2-Aug-SWH-TR-8a - no clear pattern, remove
# 2-Nov-SWH-TR-4a - no clear pattern, remove
# 2-Jul-SWH-TR-9d - poor flux, remove
# 2-Nov-SWH-TR-9a - poor flux, remove
# 2-Sep-SWH-TR-7a - poor flux, remove
...
write.csv(allflux_filtered, file="Processed Data/COMPASS_Synoptic_CB_SmartChamber_Fluxes_Final_2024_CH4.csv", row.names = FALSE)           #Change file name
