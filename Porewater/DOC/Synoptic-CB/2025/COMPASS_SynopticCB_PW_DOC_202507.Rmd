---
title: "COMPASS_SynopticCB_PW_DOC_202507_Data"
...
###### Run information - PLEASE CHANGE
  Date_Run = "7/27/25"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "Some checks off due to faulty second standard curve."  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202507.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202507_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202507.csv"
...
#qaqc log file path for this year 
  Log_path = "Raw Data/COMPASS_Synoptic_TOCTN_QAQClog_2025.csv"

```

##Set Constants Up Code
