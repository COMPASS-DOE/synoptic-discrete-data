---
title: "COMPASS_SynopticCB_PW_DOC_202607_Data"
...
###### Run information - PLEASE CHANGE
  Date_Run = "07/27/26"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "There are two runs here. & NEED TO ADD METADATA TO FINALIZE"  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name <- c("Raw Data/COMPASS_SynopticCB_PW_DOC_202607_1.txt", "Raw Data/COMPASS_SynopticCB_PW_DOC_202607_2.txt")
    
#file path and name for raw all peaks file 
    raw_allpeaks_name <- c("Raw Data/COMPASS_SynopticCB_PW_DOC_202607_1_allpeaks.txt", "Raw Data/COMPASS_SynopticCB_PW_DOC_202607_2_allpeaks.txt" )

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202607.csv"
...
#qaqc log file path for this year 
  Log_path = "Raw Data/COMPASS_Synoptic_TOCTN_QAQClog_2026.csv"
...
dat_raw <- raw_file_name %>%
  ...
  #filter(!sample_name == "202511_SWH_SWAMP_LysC_10cm_WARM")
