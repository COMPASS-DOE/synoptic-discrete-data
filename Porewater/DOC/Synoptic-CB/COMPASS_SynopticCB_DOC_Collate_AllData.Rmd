...
viz_NPOC_plot <- ggplot(data_plotting_all, aes(x = as.character(Year), y = npoc_mgL, fill = Zone)) +
  ...
  theme_classic() +
  labs(x = " ", y = "NPOC (mg/L)", title = "Synoptic CB Porewater: NPOC") +
  theme(
 ...
 viz_TDN_plot <- ggplot(data_plotting_all, aes(x = as.character(Year), y = tdn_mgL, fill = Zone)) +
  ...
  theme_classic() +
  labs(x = " ", y = "TDN (mg/L)", title = "Synoptic CB Porewater: TDN") +
  theme(
    panel.spacing = unit(.05, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) + 
  theme(text = element_text(size = 20))
...
viz_NPOC_plot_avgs <- ggplot(DOC_avg, aes(x = Date, y = mean_NPOC, color = Zone, group = Zone)) +
  ...
  theme_classic() +
  labs(x = "Date", y = "NPOC (mg/L)", title = "Synoptic CB Porewater: NPOC") +
  theme(
...
viz_TDN_plot_avgs <- ggplot(DOC_avg, aes(x = Date, y = mean_TDN, color = Zone, group = Zone)) +
  ...
  theme_classic() +
  labs(x = "Date", y = "TDN (mg/L)", title = "Synoptic CB Porewater: TDN") +
  theme(
    panel.spacing = unit(0.5, "lines"), 
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1)) +
  # theme(axis.text.x = element_text(angle = 90, hjust = 0.5))+ 
...
# Save as a PNG
png("COMPASS_SynopticCB_NPOC_alldata.png", width = 2000, height = 1200, res = 200) 
print(viz_NPOC_boxplot)  # For ggplot objects, use print()
dev.off() 

# Save as a PNG
png("COMPASS_SynopticCB_TDN_alldata.png", width = 2000, height = 1200, res = 200) 
