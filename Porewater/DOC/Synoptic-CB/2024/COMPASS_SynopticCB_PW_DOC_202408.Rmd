...
###### Run information - PLEASE CHANGE
  Date_Run = "08/24/24"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "Some samples above standard curve. Check standards for NPOC out of range."  
...
#file path and name for raw summary data file 
    ...
    raw_file_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202408.txt"
...
#file path and name for raw all peaks file 
    ...
    raw_allpeaks_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202408_allpeaks.txt" 
...
#file path and name of processed data file 
    ...
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202408.csv" #example
...
stds_C <- stds_all %>%
  ...
  filter(!str_detect(run_datetime, "8/28/2024"))
