...
###### Run information - PLEASE CHANGE
  Date_Run = "07/31/24"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "Couple of samples are above the top standard."  #any notes from the run
  ...
  chks_name = "Chk_Std_50C2N"  #what did you name your check standards? 
...
#file path and name for raw summary data file 
    ...
    raw_file_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202407.txt"
...
#file path and name for raw all peaks file 
    ...
    raw_allpeaks_name = "Raw Data/COMPASS_SynopticCB_PW_DOC_202407_allpeaks.txt" 
...
#file path and name of processed data file 
    ...
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202407.csv" #example
