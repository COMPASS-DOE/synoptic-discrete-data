...
###### Run information - PLEASE CHANGE
  Date_Run = "06/25/23"  #Date that instrument was run
  ...
  chks_name = "Std_Chk_1ppmCN"  #what did you name your check standards? 
...
#file path and name for raw summary data file 
    ...
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202306_1.txt", 
      "Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202306_2.txt")
...
#file path and name of processed data file 
    ...
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202306.csv" #example
