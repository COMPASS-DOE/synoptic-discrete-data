...
###### Run information - PLEASE CHANGE
  ...
  run_notes = "Standard Curve assessed manually on the instrument."  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202206_1.txt" , "Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202206_2.txt" )
...
colnames(IDs) <- c("Date", "Site_Code", "Zone", "Replicate", "Depth") #20220607_GWI_UP_LysB_10cm
#head(IDs)
