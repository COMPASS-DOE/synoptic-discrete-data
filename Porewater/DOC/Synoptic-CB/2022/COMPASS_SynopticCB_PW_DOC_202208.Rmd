...
###### Run information - PLEASE CHANGE
  Date_Run = "08/23/2022"  #Date that instrument was run
...
#file path and name for raw summary data file 
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202208_1.txt", "Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202208_2.txt" )
...
#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202208.csv"
...
dat_raw <- dat_raw %>% 
  mutate(sample_name = gsub("MSM_202208", "202208_MSM", sample_name))
...
colnames(IDs) <- c("Date", "Site_Code", "Zone", "Replicate", "Depth") #202208_GWI_UP_LysA_10cm
#head(IDs)
