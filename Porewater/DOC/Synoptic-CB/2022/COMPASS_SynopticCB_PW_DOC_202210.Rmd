...
###### Run information - PLEASE CHANGE
  Date_Run = "11/6/2022"  #Date that instrument was run
  ...
  samples <- c("GCrew", "Gcrew", "GWI", "MSM", "SWH") #whatever identifies your samples within the same names 
  ...
  chks_name = "_Chk_"  #what did you name your check standards? 
  
###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202210_1.txt") # , "Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202210_2.txt" )
...
#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202210.csv"
...
## Assess Duplicates - no duplicates ran
...
colnames(IDs) <- c("Date", "Site_Code", "Zone", "Replicate", "Depth") #202210_GWI_UP_LysA_10cm
#head(IDs)
