...
###### Run information - PLEASE CHANGE
  Date_Run = "07/18/2022"  #Date that instrument was run
  ...
  chks_name = "CheckStd"  #what did you name your check standards? 
  
###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202207_1.txt") # , "Raw Data/TOCTN_COMPASS_Synoptic_TCTN_202207_2.txt" )
...
#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DOC_202207.csv"
...
colnames(IDs) <- c("Date", "Site_Code", "Zone", "Replicate", "Depth") #202207_GWI_UP_LysA_10cm
#head(IDs)
