...
stds <- read.csv("Raw Data/FE_20230103_Stds.csv")
head(stds)

stdid <- read.csv("Raw Data/Stds_IDs.csv")
head(stdid)
...
FE_2_High <- ggplot(FE_2_stds_high, aes(Fe.II., Abs)) + geom_point() + geom_smooth(method = "lm", se = FALSE)
FE_2_High
...
#High curve for Fe(III)
FE_Tot_High <- ggplot(FE_Tot_stds_high, aes(Fe.II., Abs)) + geom_point() + geom_smooth(method = "lm", se = FALSE)
FE_Tot_High
...
dat <- read.csv("Raw Data/FE_20230103_Samples.csv")
head(dat)
...
head(dat_IDs)
write.csv(dat_IDs, file="Processed Data/FE_20230103_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="Processed Data/FE_20230103_Data.csv")
...
dat2 <- dat2[ ,-(3:12)]
head(dat2)
write.csv(dat2, file="Processed Data/FE_20230103_short_Data.csv")
