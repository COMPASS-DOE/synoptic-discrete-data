...
dat <- read_plate(
  file = "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/Tidy Data/20241213_COMPASS_Fe_Plate4.csv",             # full path to the .csv file
  well_ids_column = "Wells",    # name to give column of well IDs (optional)
  sep = ","                     # separator used in the csv file (optional)
)
str(dat)
...
write.csv(Fe_DiluteRerun, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241213_SamplesNeedDilution_Plate4.csv")
```
...
#Export the list of samples to rerun
write.csv(HighCVSamples2, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241213_HighCVrerun_Plate4.csv")
```
...
#Export the list of samples to rerun
write.csv(Baddups, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241213_Baddups_Plate4.csv")
```
...
#Export the list of samples to rerun
write.csv(Badspks, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241213_Badspks_Plate4.csv")
```
...
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMAPSS_Fe_20241213_Plate4_Flagdat.csv")
...
head(dat4)
write.csv(dat4, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMPASS_Fe_20241213_Plate4_shortdata.csv")
