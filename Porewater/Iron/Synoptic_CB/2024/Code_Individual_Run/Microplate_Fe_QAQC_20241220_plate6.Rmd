...
```{r}
stds <- read_plate(
  file = "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/Tidy Data/20241220_COMPASS_Fe_STD.csv",             # full path to the .csv file
...
dat <- read_plate(
  file = "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/Tidy Data/20241220_COMPASS_Fe_plate6.csv",             # full path to the .csv file
  well_ids_column = "Wells",    # name to give column of well IDs (optional)
  sep = ","                     # separator used in the csv file (optional)
)
str(dat)
...
write.csv(Fe_DiluteRerun, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241220_SamplesNeedDilution_plate6.csv")
```
...
#Export the list of samples to rerun
write.csv(HighCVSamples2, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241220_HighCVrerun_plate6.csv")
```
...
#Export the list of samples to rerun
write.csv(Baddups, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241220_Baddups_plate6.csv")
```
...
#Export the list of samples to rerun
write.csv(Badspks, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241220_Badspks_plate6.csv")
```
...
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMAPSS_Fe_20241220_plate6_Flagdat.csv")
...
head(dat4)
write.csv(dat4, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMPASS_Fe_20241220_plate6_shortdata.csv")
