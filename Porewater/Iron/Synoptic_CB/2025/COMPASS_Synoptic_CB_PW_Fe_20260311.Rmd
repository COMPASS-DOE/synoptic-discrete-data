...
Date_Run = "20260226"
plates<- c("Plate4", "Plate5", "Plate6")
Std_plates<- c("STD")
Run_by = "Zoe Read"#Instrument user
Script_run_by ="Zoe Read"#Code user
Project = "COMPASS_Synoptic_CB"
Experiment="2025"
Run_notes="The Fe2 diff std curve R squared is X, which is slightly below the 0.985 cutoff but I think is reasonable, and Melanie mentioned that this R sqaured might be lower since it is the difference between two curves and is more sensitive. The check stds for FE3 60 uM were all bad."#any notes from run
...
stds<-read_plates(
  files = "Tidy Data/20260311_COMPASS_Synoptic_CB_Fe_STD.csv",#list of all file paths
