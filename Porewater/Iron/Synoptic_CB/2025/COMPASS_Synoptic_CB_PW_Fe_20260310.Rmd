...
Experiment="2025"
Run_notes="The Fe2 diff std curve R squared is 0.9844, which is slightly below the 0.985 cutoff but I think is reasonable. The check stds for FE3 60 uM were all bad."#any notes from run
...
stds<-read_plates(
  files = "Tidy Data/20260310_COMPASS_Synoptic_CB_Fe_STD.csv",#list of all file paths
