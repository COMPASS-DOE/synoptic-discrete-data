...
stds <- read.csv("Raw Data/FE_20221219_Stds.csv")
head(stds)

#subset by FE_2 and FE_Total
FE_2_stds <- stds[stds$FE == "FE_2", ]                               # One factor level
head(FE_2_stds) 
...
dat <- read.csv("Raw Data/FE_20221219_Samples.csv")
head(dat)
...
head(dat_IDs)
write.csv(dat_IDs, file="Processed Data/FE_2022119_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="Processed Data/FE_20221219_Data.csv")
...
dat2 <- dat2[ ,-(3:12)]
head(dat2)
write.csv(dat2, file="Processed Data/FE_20221219_short_Data.csv")
