...
dat <- read_plate(
  file = "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/Tidy Data/20241230_COMPASS_Fe_plate7.csv",             # full path to the .csv file
  well_ids_column = "Wells",    # name to give column of well IDs (optional)
  sep = ","                     # separator used in the csv file (optional)
)
str(dat)
...
write.csv(Fe_DiluteRerun, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241230_SamplesNeedDilution_plate7.csv")
```
...
#Export the list of samples to rerun
write.csv(HighCVSamples2, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241230_HighCVrerun_plate7.csv")
```
...
#Export the list of samples to rerun
write.csv(Baddups, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241230_Baddups_plate7.csv")
```
...
#Export the list of samples to rerun
write.csv(Badspks, "S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/20241230_Badspks_plate7.csv")
```
...
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMAPSS_Fe_20241230_plate7_Flagdat.csv")
...
head(dat4)
write.csv(dat4, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Fe/COMPASS/Synoptic/QAQC'd Data/COMPASS_Fe_20241230_plate7_shortdata.csv")
