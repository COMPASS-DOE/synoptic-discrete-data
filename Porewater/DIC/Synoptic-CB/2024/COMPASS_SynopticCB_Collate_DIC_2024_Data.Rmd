---
title: "COMPASS_SynopticCB_Collate_DIC_2024_Data"
...
viz_dic_plot <- ggplot(data_plotting_all, aes(x = months_factor, y = ic_mgL, fill = Zone)) +
  ...
  theme_classic() +
  labs(x = " ", y = "DIC (mg/L)", title = "Synoptic CB Porewater: DIC 2024") +
  theme(
...
write.csv(final_data_lys, "COMPASS_SynopticCB_PW_DIC_2024.csv")
