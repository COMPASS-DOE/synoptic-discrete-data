...
###### Run information - PLEASE CHANGE
  Date_Run = "07/29/2024"  #Date that instrument was run
  Run_by = "Stephanie J. Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "One sample was entered into the instrument incorrectly and that is
    fixed in this code: 202407_SWH_UP_LysB_45cm is 202407_SWH_UP_LysC_45cm"  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202407.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202407_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202407.csv"
...
dat_raw <- dat_raw %>%
  mutate(sample_name = case_when(
    sample_name == "202407_SWH_UP_LysB_45cm" ~ "202407_SWH_UP_LysC_45cm",
    TRUE ~ sample_name
  ))
