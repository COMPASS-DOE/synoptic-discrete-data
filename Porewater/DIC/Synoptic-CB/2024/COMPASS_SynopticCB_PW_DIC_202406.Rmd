...
###### Run information - PLEASE CHANGE
  Date_Run = "06/28/2024"  #Date that instrument was run
  Run_by = "Stephanie Wilson"  #Instrument user 
  Script_run_by = "Stephanie Wilson" #Code user 
  run_notes = "On this run I accidentally labeled samples as 2023 instead of
    2024, so this is changed in the code that reads in the raw data. 
    No duplicates were included in this run."  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202406.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202406_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202406.csv"
...
dat_raw <- dat_raw %>%
  mutate(sample_name = str_replace(sample_name, "202306", "202406" ))
