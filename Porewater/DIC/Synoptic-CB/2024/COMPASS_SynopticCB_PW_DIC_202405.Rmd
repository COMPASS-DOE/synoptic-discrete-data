...
###### Run information - PLEASE CHANGE
  ...
  run_notes = "This month MSM UP Lysimeter A and C samples were swapped, 
  this is fixed in this code. "  #any notes from the run
...
#deal with sample names that were incorrectly labeled
dat_raw <- dat_raw %>%
  mutate(sample_name = case_when(
    sample_name == "202405_MSM_UP_LysA_10cm" ~ "202405_MSM_UP_LysC_10cm",
    sample_name == "202405_MSM_UP_LysA_20cm" ~ "202405_MSM_UP_LysC_20cm",
    sample_name == "202405_MSM_UP_LysC_20cm" ~ "202405_MSM_UP_LysA_20cm",
    TRUE ~ sample_name
  ))
