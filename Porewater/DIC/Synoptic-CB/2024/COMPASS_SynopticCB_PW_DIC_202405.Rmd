...
###### Run information - PLEASE CHANGE
  Date_Run = "05/28/2024"  #Date that instrument was run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202405.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202405_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202405.csv"
...
#qaqc log file path for this year 
  Log_path = "Raw Data/COMPASS_Synoptic_DIC_QAQClog_2024.csv"
...
C_stds_plot <- ggplot(stds_C, aes(x = standard_C_ppm, y = area)) +
  ...
  geom_text(
    data = r2_labels_c,
    aes(x = x_pos, y = y_pos, label = paste0("R squared = ", r_squared)),
    inherit.aes = FALSE,
    hjust = 1, vjust = 1,
    size = 4
  ) +
