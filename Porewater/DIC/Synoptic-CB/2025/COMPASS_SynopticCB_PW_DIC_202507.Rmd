...
###### Run information - PLEASE CHANGE
  Date_Run = "07/25/25"  #Date that instrument was run
...
#file path and name for raw summary data file 
    raw_file_name = "Raw Data/COMPASS_SynopticCB_PW_DIC_202507.txt" 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name = "Raw Data/COMPASS_SynopticCB_PW_DIC_202507_allpeaks.txt"

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202507.csv"
...
stds_C$standard_C_ppm <- as.numeric(stds_C$standard_C_ppm)
...
colnames(IDs) <- c("Date" , "Site_Code","Zone", "Lysimeter", "Depth", "Extra_Info")
#head(IDs)
