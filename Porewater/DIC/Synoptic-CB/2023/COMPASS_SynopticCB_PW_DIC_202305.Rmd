...
###### Run information - PLEASE CHANGE
  Date_Run = "06/05/23"  #Date that instrument was run
  Run_by = "Instrument User"  #Instrument user 
  Script_run_by = "Code User" #Code user 
...
#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202305.csv"
...
dat_raw <- dat_raw %>%
  mutate(sample_name = recode(sample_name,
                         "GWI_202305_UP_LysB_10cmm" = "GWI_202305_UP_LysB_10cm"))
...
## Check to see if samples run match metadata & merge info - 2023 data needs entered 
