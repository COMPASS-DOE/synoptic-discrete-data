...
###### Run information - PLEASE CHANGE
  Date_Run = "08/18/23"  #Date that instrument was run
...
#file path and name for raw summary data file 
    raw_file_name = c("Raw Data/TOCTN_COMPASS_Synoptic_DIC_202308_1.txt", 
                      "Raw Data/TOCTN_COMPASS_Synoptic_DIC_202308_2.txt")
...
dat_raw <- dat_raw %>%
  mutate(sample_name = str_replace(sample_name, "202038", "202308"))
