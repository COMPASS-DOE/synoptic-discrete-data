...
###### Run information - PLEASE CHANGE
  Date_Run = "07/26/25"  #Date that instrument was run
  Run_by = "Stephanie Wilson"  #Instrument user 
  Script_run_by = "Stephanie J. Wilson" #Code user 
  run_notes = "Most dups out of range, these are from second pulls of the syringe, so not necessarily surprising."  #any notes from the run
...
#file path and name for raw summary data file 
    raw_file_name <- c("Raw Data/COMPASS_SynopticCB_PW_DIC_202607_1.txt" ,  "Raw Data/COMPASS_SynopticCB_PW_DIC_202607_2.txt") 
    
#file path and name for raw all peaks file 
    raw_allpeaks_name <- c("Raw Data/COMPASS_SynopticCB_PW_DIC_202607_1_allpeaks.txt", "Raw Data/COMPASS_SynopticCB_PW_DIC_202607_2_allpeaks.txt")

#file path and name of processed data file 
    processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_DIC_202607.csv"
...
dat_raw <- dat_raw %>% 
  mutate(sample_name = recode(sample_name, 
                              "202607_GCW_LysA_10cm" = "202607_GCW_WC_LysA_10cm", #some sample names entered into instrument incorrectly
                              "202607_GCW_LysA_20cm" = "202607_GCW_WC_LysA_20cm", 
                              "202607_GCW_LysA_45cm" = "202607_GCW_WC_LysA_45cm",
                               "202607_GCW_LysB_10cm" = "202607_GCW_WC_LysB_10cm",
                               "202607_GCW_LysB_45cm" = "202607_GCW_WC_LysB_45cm",
                               "202607_GCW_LysC_10cm" = "202607_GCW_WC_LysC_10cm",
                               "202607_GCW_LysC_20cm" = "202607_GCW_WC_LysC_20cm",
                               "202607_GCW_LysC_45c" = "202607_GCW_WC_LysC_45cm"
                              ))
