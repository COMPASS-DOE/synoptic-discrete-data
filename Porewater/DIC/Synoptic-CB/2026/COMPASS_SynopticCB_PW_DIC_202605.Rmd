...
###### Run information - PLEASE CHANGE
  ...
  run_notes = "Check Standards are out of range. Standard curve looks good - going to accept run."  #any notes from the run
...
dat_raw <- dat_raw %>% 
  mutate(sample_name = recode(sample_name, 
                              "202606_202605_SWH_TR_LysC_20cm" = "202605_SWH_TR_LysC_20cm", #some sample names entered into instrument incorrectly
                              "202606_202605_SWH_TR_LysC_45cm" = "202605_SWH_TR_LysC_45cm", 
                              "202605_MSM_TR_Lys2_20cm" = "202605_MSM_TR_LysB_20cm",
                              "202606_MSM_SW_B" = "202605_MSM_SW_B", 
                              "202606_MSM_SW_C" = "202605_MSM_SW_C"))
