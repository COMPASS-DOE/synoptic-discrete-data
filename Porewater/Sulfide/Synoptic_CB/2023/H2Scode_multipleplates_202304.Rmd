...
Run_notes="Some sample IDs are missing from metadata: GWI_202304_WC_LYSC_45CM. 
1/6 plates had a bad dup. 2/6 plates had a bad spk. 
"#any notes from run
...
file_paths_tidydata <- list.files(path = "Tidy Data", pattern = "April", full.names = TRUE)
head(file_paths_tidydata)

#file path name for processed data
#Write out final data frame 
final_data_path <- "Processed Data/COMPASS_H2S_202304_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202304_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202304_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202304_Plates_BDL.csv"

#QAQC log path
log_path="Raw Data/Sulfide_STD_QAQC.csv"

#Sample ID Path
SampleIDs1=paste0("Raw Data/COMPASS_SampleIDs_202304.xlsx")
SampleIDs2=paste0("Raw Data/COMPASS_SampleIDs_202304.xlsx")
