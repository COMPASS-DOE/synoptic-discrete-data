...
final_data_path <- "Processed Data/COMPASS_H2S_202311_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202311_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202311_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202311_Plates_BDL.csv"

#QAQC log path
log_path="Raw Data/Sulfide_STD_QAQC.csv"

#Sample ID Path
SampleIDs1=paste0("Raw Data/COMPASS_SampleIDs_202311.xlsx")
SampleIDs2=paste0("Raw Data/COMPASS_SampleIDs_202311.xlsx")
...
H2S <- ggplot(H2S_stds, aes(Conc, Abs)) + geom_point() + geom_smooth(method = "lm", se = FALSE)+ 
  ...
  stat_regline_equation(label.x = 15, label.y = 1.7) + # Add the equation
  stat_regline_equation(aes(label = ..adj.rr.label..), label.x = 15, label.y = 1.4) # Add R squared
H2S
