...
Some samples were adl. 
Some samples missing from metadata: MSM_202206_WC_LYSA_45CM. "#any notes from run
...
file_paths_tidydata <- list.files(path = "Raw Data", pattern = "202206_Plate", full.names = TRUE)
head(file_paths_tidydata)

#file path name for processed data
#Write out final data frame 
final_data_path <- "Processed Data/COMPASS_H2S_202206_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202206_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202206_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202206_Plates_BDL.csv"
...
Sample_data1 <- Sample_data1 %>%
  ...
  separate(col = IDs, into = c("Site", "Zone", "Replicate", "Depth"), sep = " ") %>%
