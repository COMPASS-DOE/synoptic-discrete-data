...
Run_notes="No dups or spks. 
Looks like MC's were not added. 
Some samples were adl and not diluted. 
One sample still had high CV. "#any notes from run
...
file_paths_tidydata <- list.files(path = "Raw Data", pattern = "202205_Plate", full.names = TRUE)
head(file_paths_tidydata)

#file path name for processed data
#Write out final data frame 
final_data_path <- "Processed Data/COMPASS_H2S_202205_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202205_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202205_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202205_Plates_BDL.csv"

#QAQC log path
log_path="Raw Data/Sulfide_STD_QAQC.csv"

#Sample ID Path
# SampleIDs1=paste0("Raw Data/COMPASS_Nov2025_SampleIDs_20251110.xlsx")
# SampleIDs2=paste0("Raw Data/COMPASS_Nov2025_SampleIDs_20251114.xlsx")
...
Sample_data1 <- Sample_data1 %>%
  ...
  separate(col = IDs, into = c("Site", "Zone", "Depth", "Replicate"), sep = "_") %>%
  mutate(Sample_ID = paste0(Site, "_", Date_Run, "_", Zone, "_", "Sip", Replicate, "_", Depth, "cm"))
