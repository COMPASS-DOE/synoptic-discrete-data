...
##Sample ID that was entered incorrectly
## MSM_202405_UP_LYSA_10CM to MSM_202405_UP_LYSC_10CM 
SampleIDs$Replicate <- ifelse(SampleIDs$Site == "MSM" & SampleIDs$Zone == "UP" & SampleIDs$Depth == "10cm" & SampleIDs$Replicate == "LysA", "LysC",
                              SampleIDs$Replicate)
