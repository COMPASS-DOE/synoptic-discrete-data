...
dat <- stds <- read_plate(
  file = "S:/GlobalChangeEco/porewater_r scripts & Data/Data/Sulfide Microplate/COMPASS/2024 July/Tidy Data/COMPASS_H2S_20240731_plate8.csv",             # full path to the .csv file
...
#hash for first run
H2S_stds <- subset(H2S_stds, !(Wells %in% c( "E01","E02","E03","F02" )))
...
head(dat_IDs)
  write.csv(dat_IDs, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 July/QAQC'd Data/COMPASS_H2S_20240731_plate8_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 July/QAQC'd Data/COMPASS_H2S_20240731_plate8_Data.csv")
...
dat3 <- dat3[ ,-(2:5)]
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 July/QAQC'd data/COMPASS_H2S_20240731_plate8_short_Data.csv")
