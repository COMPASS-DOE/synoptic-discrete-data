...
dat <- stds <- read_plate(
  file = "S:/GlobalChangeEco/porewater_r scripts & Data/Data/Sulfide Microplate/COMPASS/2024 September/Tidy Data/COMPASS_H2S_20241001_Plate3.csv",             # full path to the .csv file
...
#hash for first run
H2S_stds <- subset(H2S_stds, !(Wells %in% c( "E01","E02","E03","D03")))
...
head(dat_IDs)
  write.csv(dat_IDs, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 September/QAQC'd Data/COMPASS_H2S_20241001_Plate3_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 September/QAQC'd Data/COMPASS_H2S_20241001_Plate3_Data.csv")
...
dat3 <- dat3[ ,-(2:5)]
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 September/QAQC'd data/COMPASS_H2S_20241001_Plate3_short_Data.csv")
