...
author: "May 2025 Samples Plate 3"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Samples 38 and 36 still have high CVs. 
  One dup+sample were 0, one dup had high percent diff (16.80756 compared to 15.5 cutoff). 
  Both spikes had very high recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("B01", "D01", "E01")
