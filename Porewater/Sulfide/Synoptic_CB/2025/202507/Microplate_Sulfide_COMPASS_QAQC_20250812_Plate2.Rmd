...
author: "July 2025 Samples Plate 2"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Samples 17 and 18 need to rerun with dilutions. 
  Both dups & respective samples have H2S values of 0. 
  One spike had a high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("C02", "D01", "E02") #Ex. c("A02", "B02")
