...
author: "July 2025 Samples Plate 5"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Std curve R squared is below cutoff: 0.9394858. 
  Std curve intercept is 2 sd different from previous intercepts. 
  Chk Std 3 is signficantly different from Std 3. 
  One duplicate & respective sample had H2S values of 0. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c("E03", "F03") #Ex. c("A02", "B02")
