...
author: "July 2025 Samples Plate 9"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  Date_Run = "20250813"  #Date that instrument was run
  Plate = "9"
  Month = "July"
  Year = "2025"
  ...
  Project = "COMPASS"
  run_notes = "There were only 3 samples in this run, so no duplicates, spikes, or check standards. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c("B01", "E01") #Ex. c("A02", "B02")
...
```{r Assess Duplicates, echo=FALSE, fig.keep = "none", warning=FALSE, include=FALSE, eval = FALSE}
...
```{r Assess Analytical Spikes, echo=FALSE, fig.keep = "none", include=FALSE, eval = FALSE}
...
```{r Plot duplicates and spikes, echo = FALSE, warning = FALSE, out.width = "100%", out.height = "100%", eval = FALSE}
