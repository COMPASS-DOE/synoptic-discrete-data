...
author: "May 2025 Samples Plate 8"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Removed std 5 because it was very low. 
  Chk std 4 is much higher than Std 4. 
  Matrix checks 10 and 20 are both higher than Std 5. 
  Samples 113 and 49 still have high CVs. 
  The only duplicate (47) had high percent difference. 
  One spk (113) had high spike recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("C01", "D01", "F01", "F02", "F03")
