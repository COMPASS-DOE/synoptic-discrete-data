...
author: "May 2025 Samples Plate 4"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Std curve R squared is low, 0.96. 
  Std curve intercept is a bit higher than previous intercepts. 
  Matrix Check 10 is significantly lower than from Std 5. 
  Sample 54 still has a high cv. 
  One dup/sample were 0 and one dup (64) had high perent difference. 
  One spk (49) had slightly high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c(NA) #c("E01", "E02", "E03", "F01", "F02", "F03")
...
#file path and name for raw summary data file 
  raw_file_name_id_dil = paste0("Raw Data/", Year, Month, "_H2S_Datasheets.xlsx")
...
#file path and name of processed data file 
  tidy_file_name = "Tidy Data/20250529_COMPASS_H2S_Plate4.csv" ##This data was hand-tidied by Melanie because the plate was ran backwards. 
