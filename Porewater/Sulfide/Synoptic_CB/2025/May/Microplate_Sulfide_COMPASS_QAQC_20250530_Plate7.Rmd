...
author: "May 2025 Samples Plate 7"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Std curve R squared is low: 0.969463
  Samples 110 and 100 still have high CVs. 
  One dup (112) had high percent difference. 
  One spk (95) had high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("B02", "C01", "D02", "E02")
