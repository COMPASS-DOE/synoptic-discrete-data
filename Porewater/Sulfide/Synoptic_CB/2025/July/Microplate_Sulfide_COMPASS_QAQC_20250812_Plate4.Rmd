...
author: "July 2025 Samples Plate 4"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  Date_Run = "20250812"  #Date that instrument was run
  Plate = "4"
  Month = "July"
  Year = "2025"
  ...
  Project = "COMPASS"
  run_notes = "Std curve R squared is below cutoff: 0.9565605. 
  Chk Std 0 is significantly different from Std 0 (Both DI water). 
  Matrix Check 10 is signficantly higher than Std 5. 
  Sample 59 still has high CV after on replicate removed. 
  Both dups & respective samples had H2S values of 0. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c(NA) #Ex. c("A02", "B02")
  
  Chkstds_to_remove <- c("D07")
