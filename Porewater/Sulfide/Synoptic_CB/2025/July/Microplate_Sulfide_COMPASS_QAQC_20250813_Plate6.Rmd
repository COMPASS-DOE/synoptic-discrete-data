...
author: "July 2025 Samples Plate 6"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Chk Std 4 is significantly different from Std 4. 
  Samples 89 and 96 still have high CVs after one replicate was removed. 
  Spk 90 had high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c("D01", "E02") #Ex. c("A02", "B02")
  
  Chkstds_to_remove <- c("D08")
