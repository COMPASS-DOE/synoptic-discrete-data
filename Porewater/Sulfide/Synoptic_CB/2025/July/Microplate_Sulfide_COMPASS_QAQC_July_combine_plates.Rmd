...
##Run Notes
```{r}
# Some sample IDs are missing from metadata.I think I had fixed these when I ran the Dionex 
# because they were ordered/numbered incorrectly compared to their labels. I changed them here as well. 
...
####Fix sample IDs####
# Change value1 and value2 where category is "A"
SampleIDs <- SampleIDs %>%
  mutate(
    Zone = if_else(Number == "70", "TR", Zone),
    Replicate = if_else(Number == "71", "LysA", Replicate))
