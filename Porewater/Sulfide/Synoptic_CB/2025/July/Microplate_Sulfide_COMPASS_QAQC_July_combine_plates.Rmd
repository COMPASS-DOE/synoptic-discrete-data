...
final_data <- merged_data %>% 
  mutate(
    ...
    Region = "CB" #need to make it so this comes out in plate processed file
  ) 
...
write.csv(final_data, "COMPASS_H2S_20250813_Plate1-8_Combined.csv")

#Write out samples that still have high CVs
write.csv(HighCV, "COMPASS_H2S_20250813_Plate1-8_HighCVs.csv")

#Write out ADL samples
write.csv(ADL_not_fixed, "COMPASS_H2S_20250813_Plate1-8_ADL.csv")

#Write out BDL samples
write.csv(BDL_not_fixed, "COMPASS_H2S_20250813_Plate1-8_BDL.csv")
