...
author: "July 2025 Samples Plate 7"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Samples 103 and 106 still have high CVs after one replicate removed. 
  Dup 105 had high percent difference, the other dup & sample had H2S values of 0. 
  Spk 97 had high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c("F01") #Ex. c("A02", "B02")
