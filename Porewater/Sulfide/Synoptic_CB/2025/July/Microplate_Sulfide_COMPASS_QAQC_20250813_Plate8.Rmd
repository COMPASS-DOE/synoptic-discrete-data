...
author: "July 2025 Samples Plate 8"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Samples 100 and 44 still have high CVs after removing one replicate. 
  Samples 15 and 43 need to be rerun with dilutions. 
  Duplicate 100 had high percent difference. 
  Spk 44 had high percent recovery. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs - CHECK THESE! 
  stds_to_remove <- c("B02") #Ex. c("A02", "B02")
