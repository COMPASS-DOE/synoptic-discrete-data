...
##Run Notes
```{r}
# Some sample IDs are missing from metadata.I thik I had changed fixed these when I ran the Dionex because they were ordered/numbered incorrectly compared to their labels. 
#70_GWI_202507_WC_LYSC_20CM was actually 70_GWI_202507_TR_LysC_20cm 
#71_GWI_202507_WC_LysC_45cm was actually 71_GWI_202507_WC_LysA_45cm
...
Old_ID_1 = "GWI_202507_WC_LYSC_20CM"
New_ID_1 = "GWI_202507_TR_LysC_20cm"

Old_ID_2 = "GWI_202507_WC_LYSC_45CM"
New_ID_2 = "GWI_202507_WC_LysA_45cm"
...
#Read in Sample IDs
SampleIDs <- read_excel("Raw Data/202507_SampleList.xlsx")
...
##Fix sample IDs entered incorrectly
```{r Fix data entered incorrectly, include = FALSE}
##Data entered incorrectly
Sample_data_nodups$IDs[Sample_data_nodups$IDs == Old_ID_1] <- New_ID_1
Sample_data_nodups$IDs[Sample_data_nodups$IDs == Old_ID_2] <- New_ID_2
...
final_data <- merged_data %>% 
  mutate(
    ...
    Region = "CB", 
    Analysis_rundate = "20250529" #need to make it so this comes out in plate processed file
  ) 
...
write.csv(final_data, "COMPASS_H2S_20250529_Plate1-8_Combined.csv")

#Write out samples that still have high CVs
write.csv(HighCV, "COMPASS_H2S_20250529_Plate1-8_HighCVs.csv")

#Write out ADL samples
write.csv(ADL_not_fixed, "COMPASS_H2S_20250529_Plate1-8_ADL.csv")

#Write out BDL samples
write.csv(BDL_not_fixed, "COMPASS_H2S_20250529_Plate1-8_BDL.csv")
