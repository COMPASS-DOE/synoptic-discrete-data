...
author: "September 2025 Samples Plate 5"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Matrix Check 20 is significantly different from Std 5. 
  Samples 97, 102, 100 still had high CVs after one reprlicate was removed. 
  Samples 91, 94, 98 need to be diluted. 
  Spk 102 had high recovery. 
  10 uL of spike added." #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("C01", "D03") #Ex. c("A02", "B02")
