...
author: "November 2025 Samples Plate 1 20251110"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "Samples 11, 8, 12, 20, and 22 still had high CV's after one rep removed. 
  Duplicate was bad, and I forgot to add the spike. 
  Sample 21 needs to be diluted. 
  50 uL of spike added. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("B02", "C01", "D01", "E03") #Ex. c("A02", "B02")
