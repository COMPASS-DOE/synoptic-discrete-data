...
###### Run information - PLEASE CHANGE
  ...
  Project = "COMPASS"
  run_notes = "MC 10 was bad. 
  Samples 25, 27, and 30 still had high CVs after one replicate was removed. 
  Sup and respective sample both had H2S values of 0. 
  Spk was bad. 
  50 uL of spike added. 
  " #any notes from the run

###### STDs to remove manually - NA unless standards have high CVs
  stds_to_remove <- c("C02", "D03", "E03") #Ex. c("A02", "B02")
