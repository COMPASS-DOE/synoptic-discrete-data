...
Run_notes="A few of the samples were adl. 
Used Std curve from Plate 4. 
MC 20 from Plate 2 was bad. 
1/9 plates had bad dup, 4/9 plates had bad spk. 
"#any notes from run
...
Old_ID_1 = "SWH_WC_LysB45cm"
New_ID_1 = "SWH_WC_LysB_45cm"
...
final_data_path <- "Processed Data/COMPASS_H2S_202307_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202307_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202307_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202307_Plates_BDL.csv"

#QAQC log path
log_path="Raw Data/Sulfide_STD_QAQC.csv"

#Sample ID Path
SampleIDs1=paste0("Raw Data/COMPASS_SampleIDs_202307.xlsx")
SampleIDs2=paste0("Raw Data/COMPASS_SampleIDs_202307.xlsx")
...
dat<-read_plates(
  files = paste0("Tidy Data/", file_paths_tidydata),            #list of all file paths
...
Sample_data1 <- all_data1 %>% 
  ...
  mutate(IDs = gsub("RHZ_WC", "WC_RHZ", IDs))
# %>% 
#   subset((!IDs %like% "PPR")) %>% 
#   subset((!IDs %like% "RHZ"))
