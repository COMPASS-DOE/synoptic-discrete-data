...
Run_notes="Plate 5 std curve used. 
MC's both bad on Plates 1 and 3, MC 10 bad on Plates 2 and 7.  
2/7 plates had a bad dup. 
2/6 plates had a bad spk. 
"#any notes from run

#Stds that should be excluded
stds_to_remove<-data.frame(Plate=c("Plate3", "Plate4"),IDs=c("Std 2"))
# stds_to_remove<-NA
