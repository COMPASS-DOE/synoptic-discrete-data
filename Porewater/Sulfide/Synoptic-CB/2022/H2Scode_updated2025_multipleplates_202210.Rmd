...
Run_notes="October sample 143/reruns plate was not run.
Plate 1 Std curve R squared was low and slope was different from previous std curves. 
Plate 2 both MC's were off. 5/9 spks were good. 
"#any notes from run
...
# New_ID_1 <- "2_Gcrew 202210_UP_LysB_10cm"
# 
# Old_ID_2 <- "4_Gcrew_ 202210_UP__LysB_45cm"
# New_ID_2 <- "4_Gcrew_202210_UP_LysB_45cm"
...
file_paths_tidydata <- list.files(path = "Raw Data", pattern = "202210_Plate", full.names = TRUE)
head(file_paths_tidydata)

#file path name for processed data
#Write out final data frame 
final_data_path <- "Processed Data/COMPASS_H2S_202210_Plates_Combined.csv"
HighCV_path <- "Processed Data/COMPASS_H2S_202210_Plates_HighCVs.csv"
ADL_not_fixed_path <- "Processed Data/COMPASS_H2S_202210_Plates_ADL.csv"
BDL_not_fixed_path <- "Processed Data/COMPASS_H2S_202210_Plates_BDL.csv"

#QAQC log path
log_path="Raw Data/Sulfide_STD_QAQC.csv"

#Sample ID Path
SampleIDs1=paste0("Raw Data/COMPASS_Synoptic_CB_H2S_202210_Lys_IDs.csv")
