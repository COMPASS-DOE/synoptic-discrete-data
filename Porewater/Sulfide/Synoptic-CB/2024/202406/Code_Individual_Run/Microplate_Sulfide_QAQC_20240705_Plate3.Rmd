...
dat <- stds <- read_plate(
  file = "S:/GlobalChangeEco/porewater_r scripts & Data/Data/Sulfide Microplate/COMPASS/2024 June/Tidy Data/COMPASS_H2S_20240705_plate3.csv",             # full path to the .csv file
...
head(dat_IDs)
  write.csv(dat_IDs, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 June/QAQC'd Data/COMPASS_H2S_20240705_plate3_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 June/QAQC'd Data/COMPASS_H2S_20240705_plate3_Data.csv")
...
dat3 <- dat3[ ,-(2:5)]
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/COMPASS/2024 June/QAQC'd data/COMPASS_H2S_20240705_plate3_short_Data.csv")
