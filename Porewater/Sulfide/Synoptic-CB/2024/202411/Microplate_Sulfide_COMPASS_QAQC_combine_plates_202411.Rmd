...
author: "November 2024 All Plates"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
all_data <- read.csv("QAQC'd Data/COMPASS_H2S_202411_plate1-8_Summary_Data.csv")
all_data$X <- NULL
...
#Read in Sample IDs
SampleIDs <- read_excel("202411_SampleList.xlsx")
...
final_data <- merged_data %>% 
  mutate(
    ...
    Region = "CB", 
    Analysis_rundate = "20241118", #need to make it so this comes out in plate processed file
    Run_notes  = run_notes
  ) 
...
write.csv(final_data, "COMPASS_H2S_202411_Plates_Combined_Data.csv")

#Write out samples that still have high CVs
write.csv(HighCV, "COMPASS_H2S_202411_Plates_Combined_HighCVs.csv")

#Write out ADL samples
write.csv(ADL_not_fixed, "COMPASS_H2S_202411_Plates_Combined_ADL.csv")

#Write out BDL samples
write.csv(BDL_not_fixed, "COMPASS_H2S_202411_Plates_Combined_BDL.csv")
