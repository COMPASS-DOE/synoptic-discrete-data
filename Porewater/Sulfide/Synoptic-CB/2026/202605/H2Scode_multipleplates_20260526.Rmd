...
author: "May 2026 Samples Ran on 20260526"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: false
...
Run_notes="Used Plate 6 Std Curve. 1/6 dups bad, probably because the original value was 0. 3/6 spks were high. "#any notes from run
...
file_paths_tidydata <- list.files(path = "Tidy Data", pattern = "20260526.*\\.csv$", full.names = TRUE)
head(file_paths_tidydata)

#file path name for processed data
#Write out final data frame 
final_data_path <- "COMPASS_H2S_20260526_Plates_Combined.csv"
HighCV_path <- "COMPASS_H2S_20260526_Plates_HighCVs.csv"
ADL_not_fixed_path <- "COMPASS_H2S_20260526_Plates_ADL.csv"
BDL_not_fixed_path <- "COMPASS_H2S_20260526_Plates_BDL.csv"
...
```{r Format data and remove dups, spks, and TMP samples, include=FALSE}
...
#GCW_WC_A_10 to GCW_202605_UP_LysA_10cm
