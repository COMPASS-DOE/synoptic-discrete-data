...
df_all <- df_all %>% 
  mutate(Sample_Name = gsub("MMS_202306_UP_LysB_45cm", "MSM_202306_UP_LysB_45cm", Sample_Name))
...
#Pull out samples 
samples <- df_all_cor %>%  
  filter(!str_detect(Sample_Name, c("Standard|Chk|Duplicate|Spike|Blank|ammonia|mg/L|CCV|CCB|pe_CHK")))     
