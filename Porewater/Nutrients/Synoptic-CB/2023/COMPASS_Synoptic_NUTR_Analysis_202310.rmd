...
cat("Run Information: Input by I. Van Benschoten") #lets you know what section you're in 
#set the run date & user name 
  run_date <- "01/27/24"
  sample_year <- 2023
  sample_month <- "October"
  user <- "Stephanie Wilson"

#identify the files you want to read in 
  #read in as a list to accommodate multiple runs in a month
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_Oct2023_1.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_Oct2023_2.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_Oct2023_3.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Oct2023_1.csv", 
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Oct2023_2.csv",
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Oct2023_3.csv")
...
#Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202310.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "This run has limited spike checks for NH3 and PO4.
  peCheck for NH3 is out of range, all other run metrics are fine, 
  so accepting this run."
...
ifelse(NOx_spk_percent >= chks_flag, 
       ">60% of NOx Spikes have a CV <50% - PROCEED",
       "<60% of NOx Spikes have a CV <50% - REASSESS")
ifelse(NH3_spk_percent >= chks_flag, 
       ">60% of NH3 Spikes have a CV <50% - PROCEED",
       "<60% of NH3 Spikes have a CV <50% - REASSESS")
ifelse(PO4_spk_percent >= chks_flag, 
       ">60% of PO4 Spikes have a CV <50% - PROCEED",
       "<60% of PO4 Spikes have a CV <50% - REASSESS")
