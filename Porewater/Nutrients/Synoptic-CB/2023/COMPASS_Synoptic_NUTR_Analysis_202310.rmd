---
title: "Synoptic_CB_Nutrients_2023_October"
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202310.xlsx"

#record any notes about the run or anything other info here: 
  run_notes <- "PO4 Autospikes not included in this QAQC"
...
ifelse(PO4_spk_percent >= chks_flag, 
       "PO4 Spikes not included in this run",
       "PO4 Spikes not included in this run")
