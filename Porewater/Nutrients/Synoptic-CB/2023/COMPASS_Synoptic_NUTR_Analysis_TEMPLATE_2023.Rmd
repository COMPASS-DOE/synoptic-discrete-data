...
#record any notes about the run or anything other info here: 
  ...
  they are listed below and have been checked against metadata"
...
if (dil_dups_string != "") {
  ...
  if (any(df_duplicates$Dilution > 0, na.rm = TRUE)) {
    ...
    message("No Dilution, Most likely sample name input error, refer to sample log")
  }
...
#we can make a new dataframe here that has rhizon samples 
  #if they exist pulled into a new dataframe and exported to a folder in processed data called Rhizons


#we can make a new dataframe here that has Peeper samples 
  #if they exist pulled into a new dataframe and exported to a folder in processed data called Peepers
