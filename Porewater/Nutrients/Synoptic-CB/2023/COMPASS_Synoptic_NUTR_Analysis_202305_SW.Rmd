...
#identify the files you want to read in 
  ...
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_May2023_1.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_May2023_2_redo.csv", 
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_May2023_3_redoA.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_May2023_1redopo4.csv", 
...
#record any notes about the run or anything other info here: 
  run_notes <- "NEED TO RERUN NH3 and PO4 for this run..."
  
#samples to remove: 
  remove <- c("GCW_202304_TR_LysB_20cm_13") #not changed bc no need right now 
  #these were put on the run twice and can be removed
...
#remove rows with sample names in remove list 
df <- df %>%
...
samples_flagged <- samples_flagged %>%
  ...
  filter(!str_detect(Sample_Name, "RHZ|PPR|TEMPEST")) %>% 
