...
#record any notes about the run or anything other info here: 
  run_notes <- "NH3 3rd Party Check off, but all other run 
  parameters are fine so accepting this run.
  NOx duplicates out of range due to low sample concentrations.
  "
  
#samples to remove: 
  remove <- c("GCW_202304_TR_LysB_10cm_11", "GCW_202304_TR_LysB_20cm_13") 
