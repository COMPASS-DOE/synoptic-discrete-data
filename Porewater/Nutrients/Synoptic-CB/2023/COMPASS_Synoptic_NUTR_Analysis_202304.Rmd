...
#identify the files you want to read in 
  ...
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_April2023.csv", 
...
df_all <- df_all %>% 
  mutate(Sample_Name = gsub("MMS_202304_WC_LysB_10cm", "MSM_202304_WC_LysB_10cm", Sample_Name))
...
samples_flagged <- samples_flagged %>%
  ...
  # filter(!str_detect(Sample_Name, "TEMPEST")) %>% #RHZ|PPR|
