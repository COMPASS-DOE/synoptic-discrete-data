...
cat("Run Information: 2023/11 - I. Van Benschoten") #lets you know what section you're in 
...
#identify the files you want to read in 
  ...
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_Nov2023_1.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_Nov2023_2.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_Nov2023_3.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Nov2023_1.csv", 
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Nov2023_2.csv",
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_Nov2023_3.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202311.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "The NH3 peCheck is high for this run, but other run metrics
  look fine so we are accepting this run."
