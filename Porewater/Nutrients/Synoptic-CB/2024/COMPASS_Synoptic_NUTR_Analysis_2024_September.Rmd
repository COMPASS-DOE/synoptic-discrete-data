...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_2024MM.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "Reduction efficiency check was only ran for some of the runs within this month."
...
if (dil_dups_string != "") {
  ...
  if (nrow(bad_dups) > 0) {
    cat("\n❗ Duplicated samples with NO dilution (possible input error):\n")
    print(bad_dups)
  } else {
