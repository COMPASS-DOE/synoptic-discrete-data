---
title: "Synoptic CB: Porewater Nutrients: TEMPLATE"
...
cat("Run Information: Who Ran Code") #lets you know what section you're in 
#set the run date & user name 
  run_date <- "MM/DD/YYYY"
  sample_year <- YEAR
  sample_month <- MONTH
  user <- "Who Ran the instrument"

#identify the files you want to read in 
  #read in as a list to accommadate ultiple runs in a month
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_DATE_1.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_DATE_2.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_DATE_3.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_DATE_1.csv", 
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_DATE_2.csv",
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_DATE_3.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_DATE.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "Put any notes about peChecks, dups, issues with run etc."
...
## OPTIONAL Nameing Error Chunk 
```{r Sample Name Errors - DELETE IF NO ERROR, echo = false}
...
```{#r if csv isnt working, echo = FALSE}
