...
#identify the files you want to read in 
  ...
  NOx_files <- c("Raw Data/COMPASS_Synoptic_CB_202406_NOx_1.csv")
  NH3_PO4_files <- c("Raw Data/COMPASS_Synoptic_CB_202406_NH3_PO4_1.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202406.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "Some sample IDs are missing from metadata: SWH_202406_WC_LysA_45cm. 
  SWH_TR_LysC_10cm has a very high CV between duplicates "
