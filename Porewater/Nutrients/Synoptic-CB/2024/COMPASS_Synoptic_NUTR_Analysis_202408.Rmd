...
Old_ID_1 <- "SWH_202408_SWAMP_LycC_45cm"
New_ID_1 <- "SWH_202408_SWAMP_LysC_45cm"

Old_ID_2 <- "SWH_202408_TR_LysC_45"
New_ID_2 <- "SWH_202408_TR_LysC_45cm"
...
#identify the files you want to read in 
  ...
  NOx_files <- c("Raw Data/COMPASS_Synoptic_CB_202408_VNOx_1.csv")
  NH3_PO4_files <- c("Raw Data/COMPASS_Synoptic_CB_202408_NH3_PO4_1.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202408.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "PO4 pe check was out of range as well as it's duplicates and spikes. 
                Would reccommend rerunning the PO4 for this SWH run. "
