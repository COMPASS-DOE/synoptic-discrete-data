...
author: "October of Data Being Analyzed"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: true
...
#identify the files you want to read in 
  ...
  NOx_files <- c("Raw Data/COMPASS_Synoptic_CB_202410_VNOx_1.xlsx")
  NH3_PO4_files <- c("Raw Data/COMPASS_Synoptic_CB_202410_NH3_PO4_1.xlsx")
...
#record any notes about the run or anything other info here: 
  run_notes <- "Nitrate and nitrite reduction efficiency is okay, graph off 
  because only one run for this month. Performance check for NOx was significantly lower"
...
#Read in Raw Data 
data_NOx <- map(NOx_files, read_excel)
data_NH3_PO4 <- map(NH3_PO4_files, read_excel)
