...
#set the run date & user name 
  ...
  sample_year <- "YYYY"
  sample_month <- "Month"
  user <- "Name of Instrument User"

#identify the files you want to read in 
  #read in as a list to accommadate ultiple runs in a month
  NOx_files <- c("Raw Data/COMPASS_Synoptic_CB_2024MM_VNOx_1.csv", 
                 "Raw Data/COMPASS_Synoptic_CB_2024MM_VNOx_2.csv")
  NH3_PO4_files <- c("Raw Data/COMPASS_Synoptic_CB_2024MM_NH3_PO4_1.csv", 
                     "Raw Data/COMPASS_Synoptic_CB_2024MM_NH3_PO4_2.csv")
