...
#set the run date & user name 
  ...
  sample_year <- "2024"
  sample_month <- "May"
  user <- "Isabelle Van Benschoten & Stephanie Wilson"

#identify the files you want to read in 
  #read in as a list to accommadate ultiple runs in a month
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_202406_1.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202406_1.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_DATE.xlsx"
