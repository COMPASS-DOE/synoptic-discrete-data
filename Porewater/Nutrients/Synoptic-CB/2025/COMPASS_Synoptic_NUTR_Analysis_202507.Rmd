...
Old_ID_1 <- "GWI_202507_UP_LysC_45"
New_ID_1 <- "GWI_202507_UP_LysC_45cm"

#identify the files you want to read in 
  #read in as a list to accommodate multiple runs in a month
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_202507_1.csv",
                 "Raw Data/SEAL_COMPASS_Synoptic_NOx_202507_2.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202507_1.csv",
                     "Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202507_2.csv", 
                     "Raw Data/SEAL_COMPASS_Synoptic_PO4_202507_2_GOOD.csv")
...
# Define the file path for QAQC log file - NO Need to change just check year 
  ...
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202507.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "On the second NH3/PO4 run the PO4 standard curve was bad, so we reran those."
