...
all_data <- subset(all_data, Sample_ID != "MSM_202211_WC_SIPA_45CM")
all_data <- subset(all_data, Sample_ID != "GWI_202209_TR_10CM_EXTRACM")
...
#write out a run notes to data frame
merged_data$Run_notes <- ifelse(
    is.na(merged_data$Run_notes),
    paste0("", run_notes), 
    paste0(merged_data$Run_notes, "; ", run_notes))
