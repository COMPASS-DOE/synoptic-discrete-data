...
#set the run date & user name 
  ...
  sample_year <- 2022
  sample_month <- 05
  user <- "Stephanie J. Wilson"

#identify the files you want to read in 
  #read in as a list to accommadate ultiple runs in a month
  NOx_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NOx_202205.csv")
  NH3_PO4_files <- c("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202205.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_COMPASS_Synoptic_QAQC_Log_2022.csv"
  final_path <- "Processed Data/COMPASS_Synoptic_Nutrients_202205.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "No Nox data for this month, so need to remove all of that."
