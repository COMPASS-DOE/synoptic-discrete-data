---
title: "COMPASS_Synoptic_SEAL_Data_Analysis_Oct2022"
...
#read in data 
file1 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202210_1.csv")
...
#read in data 
file2 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202210_2.csv")
#Quick look at dataframe
head(file2)
#take out only the columns that we need 
...
#read in data 
file3 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202210_3.csv")
#Quick look at dataframe
head(file3)
#take out only the columns that we need 
...
#read in data 
file4 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202210_4.csv")
#Quick look at dataframe
head(file4)
#take out only the columns that we need 
dat4 <- file4[ ,c(1,4,6,7, 9, 12, 13)]
# assigning new names to the columns of the data frame
colnames(dat4) <- c('Run_Info','Sample_Name','Conc', "Abs", "Dilution", "Units", "Test")
dat4$Run_Number <- "4"
head(dat4)

#read in data 
file5 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202210-11_4.csv")
#Quick look at dataframe
head(file5)
#take out only the columns that we need 
dat5 <- file5[ ,c(1,4,6,7, 9, 12, 13)]
# assigning new names to the columns of the data frame
colnames(dat5) <- c('Run_Info','Sample_Name','Conc', "Abs", "Dilution", "Units", "Test")
dat5$Run_Number <- "5"
head(dat5)
...
#read in data 
Nfile1 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202210_1.csv")
#Quick look at dataframe
head(Nfile1)
#take out only the columns that we need 
...
#read in data 
Nfile2 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202210_2.csv")
#Quick look at dataframe
head(Nfile2)
#take out only the columns that we need 
...
#read in data 
Nfile3 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202210_3.csv")
#Quick look at dataframe
head(Nfile3)
#take out only the columns that we need 
...
#read in data 
Nfile4 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202210_4.csv")
#Quick look at dataframe
head(Nfile4)
#take out only the columns that we need 
Ndat4 <- Nfile4[ ,c(1,4,6,7, 9, 12, 13)]
# assigning new names to the columns of the data frame
colnames(Ndat4) <- c('Run_Info','Sample_Name','Conc', "Abs", "Dilution", "Units", "Test")
Ndat4$Run_Number <- "4"
head(Ndat4)

#read in data 
Nfile5 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202210-11_4.csv")
#Quick look at dataframe
head(Nfile5)
#take out only the columns that we need 
Ndat5 <- Nfile5[ ,c(1,4,6,7, 9, 12, 13)]
# assigning new names to the columns of the data frame
colnames(Ndat5) <- c('Run_Info','Sample_Name','Conc', "Abs", "Dilution", "Units", "Test")
Ndat5$Run_Number <- "5"
head(Ndat5)

Nalldat <- rbind(Ndat1, Ndat2, Ndat3, Ndat4, Ndat5)
...
```{r Dilution Corrections NOx, echo=FALSE}
...
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_Nutrients_202210-11.csv")
