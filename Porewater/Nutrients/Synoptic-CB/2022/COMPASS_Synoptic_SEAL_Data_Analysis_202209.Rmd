...
##Run notes
```{r}
Run_notes = "GWI_202209_TR_LysC_10cm was duplicated without a dilution for Vanadium NOx. Appears to be run twice by accident, 
            measured concentrations are essentially equal, removed second run (duplicate) in this code."
```
...
#There is a duplicate in this run for no reason, we remove the 2nd one here because the numbers are essentially equal for both 
Nfile2 <- Nfile2 %>%
  filter(!X1.15.2023.13.28 == "U28")
