---
title: "COMPASS_Synoptic_SEAL_Data_Analysis_May2022"
...
#read in data 
file1 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202205.csv")
...
## NOx - Not run for the first month
```{#r}
...
colnames(IDs) <- c("Site" ,"Zone", "Type", "Sampling", "Date", "Replicate", "Depth")
IDs$Month <- "May"
head(IDs)
...
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_Nutrients_202205.csv")
