---
title: "COMPASS_Synoptic_SEAL_Data_Analysis_Aug2022"
...
```{r}
#read in data 
file1 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202208_1.csv")
...
#read in data 
file2 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202208_2.csv")
#Quick look at dataframe
head(file2)
#take out only the columns that we need 
...
#read in data 
file3 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NH3_PO4_202208_3.csv")
#Quick look at dataframe
head(file3)
#take out only the columns that we need 
...
#read in data 
Nfile1 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202208_1.csv")
#Quick look at dataframe
head(Nfile1)
#take out only the columns that we need 
...
##This second run is the same as Run 1

# #read in data 
# Nfile2 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202208_2.csv")
# #Quick look at dataframe
# head(Nfile2)
# #take out only the columns that we need 
...
#read in data 
Nfile3 <- read.csv("Raw Data/SEAL_COMPASS_Synoptic_NOx_202208_3.csv")
#Quick look at dataframe
head(Nfile3)
#take out only the columns that we need 
...
#Export Data
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_Nutrients_202208.csv")
