...
###### Run information - PLEASE CHANGE
  Date_Run = "2026-07-30"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  run_notes = "17_202607_MSM_TR_LysC_20cm was adl for SO4: 20.929540 vs 20 ppm top std" #any notes from the run
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/COMPASS_Synoptic_CB_MonMon_202607_MSM_GWI_Cl.txt"
  raw_file_name_so4 = "Raw Data/COMPASS_Synoptic_CB_MonMon_202607_MSM_GWI_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_MSM_GWI_202607.csv" 
...
##Fix samples that were entered incorrectly
# all_dat <- all_dat %>%  
#   filter(!str_detect(sample_ID, samples_to_remove),ignore_case = TRUE)
...
all_data_flagged <- all_data_flagged %>%
  separate(
    col = sample_ID,
    sep = "_",
    into = c("Date", "Site_Code", "Zone", "LysID", "Depth"),
    remove = FALSE) %>% 
