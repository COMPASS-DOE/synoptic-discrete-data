...
Sdat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202207_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202207_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
## Fix Sample IDs
```{r Fix sample IDs}
# all_dat$Sample_ID[all_dat$Sample_ID == "13_202207_GCrew_TR_LysA_45"] <- "13_202207_GCrew_TR_LysA_45_cm"

##Based on sample list order, 36_202207_GWI_UP_LysA_10cm was probably actually 36_202207_GWI_TR_LysA_10cm
all_dat <- all_dat %>% 
  mutate(Sample_ID = gsub("13_202207_GCrew_TR_LysA_45","13_202207_GCrew_TR_LysA_45cm", Sample_ID), 
         Sample_ID = gsub("36_202207_GWI_UP_LysA_10cm","36_202207_GWI_TR_LysA_10cm", Sample_ID))
...
colnames(IDs) <- c("Analysis_No" ,"Date","Site", "Zone", "Replicate", "Depth", "Tree_ID")
head(IDs)
...
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_202207.csv")      #Change file name
