---
title: "Dionex_COMPASS_October2022"
...
Sdat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202210_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202210_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
## Make final dataframe with IDs  
```{r}
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_202210.csv") #Change file name
