...
write.csv(all_dat, "COMPASS_SynopticCB_SO4_Cl_AllData.csv", row.names = FALSE)


#write out a csv of the metadata associated with the data: 
write.csv(metadat, "COMPASS_SynopticCB_SO4_Cl_Metadata.csv", row.names = FALSE)
