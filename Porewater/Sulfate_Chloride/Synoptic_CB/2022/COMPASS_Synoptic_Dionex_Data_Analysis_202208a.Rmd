...
Sdat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202208_SO4a.txt", sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202208_Cla.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_202208a.csv")  #Change file name
