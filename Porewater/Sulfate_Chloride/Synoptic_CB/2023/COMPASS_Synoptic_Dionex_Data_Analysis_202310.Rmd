...
Sdat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202310_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("raw Data/COMPASS_Synoptic_CB_MonMon_202310_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_202310.csv")           #Change file name
