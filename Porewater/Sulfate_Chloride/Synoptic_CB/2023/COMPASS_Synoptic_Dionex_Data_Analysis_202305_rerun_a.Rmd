---
title: "Dionex_COMPASS_May_2023_rerun_a"
...
Sdat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202305_rerun_SO4a.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("Raw Data/COMPASS_Synoptic_CB_MonMon_202305_rerun_Cla.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
string_to_find <- "MSM_202305_UP_LysA_10cm"
found <- any(sapply(all_dat, function(x) any(grepl(string_to_find, x))))
...
QAspks$Dilution <- 1
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "MSM") & str_detect(QAspks$Sample_ID, "UP"), 50, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "MSM") & str_detect(QAspks$Sample_ID, "TR"), 50, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "MSM") & str_detect(QAspks$Sample_ID, "WC"), 100, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "MSM") & str_detect(QAspks$Sample_ID, "SW"), 100, QAspks$Dilution)

QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GCW") & str_detect(QAspks$Sample_ID, "UP"), 50, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GCW") & str_detect(QAspks$Sample_ID, "TR"), 50, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GCW") & str_detect(QAspks$Sample_ID, "WC"), 100, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GCW") & str_detect(QAspks$Sample_ID, "SW"), 100, QAspks$Dilution)

QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GWI") & str_detect(QAspks$Sample_ID, "UP"), 100, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GWI") & str_detect(QAspks$Sample_ID, "TR"), 100, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GWI") & str_detect(QAspks$Sample_ID, "WC"), 200, QAspks$Dilution)
QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "GWI") & str_detect(QAspks$Sample_ID, "SW"), 200, QAspks$Dilution)

QAspks$Dilution <-  ifelse(str_detect(QAspks$Sample_ID, "SWH"), 50, QAspks$Dilution)
...
colnames(IDs) <- c("Analysis_No" , "Site", "Date", "Zone", "Replicate", "Depth")
head(IDs)
...
## Make final dataframe with IDs  
```{r}
write.csv(alldat, file="Processed Data/COMPASS_SynopticCB_PW_Processed_Cl_SO4_202305_rerun_a.csv")    #Change file name
