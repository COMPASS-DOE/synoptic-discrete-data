...
Sdat <- read.table("COMPASS_Synoptic_CB_MonMon_202311_SO4.txt",sep='\t' , header=T, skip=3)
head(Sdat)
...
#Chloride data 
## Read in raw data file from Dionex - copied and saved as a txt
Cldat <- read.table("COMPASS_Synoptic_CB_MonMon_202311_Cl.txt",sep='\t' , header=T, skip=3)
head(Cldat)
...
write.csv(alldat, file="COMPASS_Synoptic_CB_Dionex_ClSo4_Final_202311.csv")           #Change file name
