...
###### Run information - PLEASE CHANGE
  ...
  run_notes = "Two SO4 duplicates had high CVs. 
  ...
  MSM_202405_UP_LYSA_10CM - this sample ID was changed to MSM_202405_UP_LYSC_10CM. 
...
##Fix samples that were entered incorrectly
  ...
  Old_ID_1 = "MSM_202405_UP_LYSA_10CM"
  New_ID_1 = "MSM_202405_UP_LYSC_10CM"
...
all_data_flagged$sample_ID <- str_replace(all_data_flagged$sample_ID, Old_ID_1, New_ID_1)
all_data_flagged$sample_name <- str_replace(all_data_flagged$sample_name, Old_ID_1, New_ID_1)
