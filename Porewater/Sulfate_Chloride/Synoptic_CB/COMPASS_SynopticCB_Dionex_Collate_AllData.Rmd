...
##Summarize SO4 and Cl by Date, Site, and Zone
viz_cl_boxplot <- ggplot(all_dat_dates, aes(x = Zone_1, y = Cl_Conc_mM, fill = Zone_1, group = Zone_1)) +
  geom_boxplot() + 
...
viz_so4_boxplot <- ggplot(all_dat_dates, aes(x = Zone_1, y = SO4_Conc_mM, fill = Zone_1, group = Zone_1)) +
  geom_boxplot() +
  facet_grid( ~ Site, scales = "free_x") +
  scale_x_discrete(drop = TRUE) +
  scale_fill_manual(values = c(
