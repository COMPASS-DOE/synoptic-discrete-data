---
title: "COMPASS_Synoptic_TGW_2022: Oct part 2 & Nov"
...
#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_TGW_202210-11.csv")
head(raw)
...
Slopes$Run_Date <- c(202211, 202211, 202211)
...
write.csv(final, "Processed Data/COMPASS_Synoptic_TGW_202210-11_Processed.csv")
