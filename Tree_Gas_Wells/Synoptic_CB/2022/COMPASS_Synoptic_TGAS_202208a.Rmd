---
title: "COMPASS_Synoptic_TGW_2022: August- Run #2 (a)"
...
#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_TGW_202208a.csv")
head(raw)
...
Slopes$Run_Date <- c(202208.5, 202208.5, 202208.5)

log <- read.csv("Raw Data/COMPASS_Synoptic_Varian_TGAS_QAQC_2022.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "Raw Data/COMPASS_Synoptic_Varian_TGAS_QAQC_2022.csv")
```
...
write.csv(final, "Processed Data/COMPASS_Synoptic_TGW_202208a_Processed.csv")
