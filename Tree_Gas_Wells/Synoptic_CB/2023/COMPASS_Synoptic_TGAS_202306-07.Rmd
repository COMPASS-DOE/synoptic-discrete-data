---
title: "COMPASS_Synoptic_TGW_2023: June & July"
...
#Read in June Data 
raw <- read.csv("Raw Data/COMPASS_CBSYN_TGW_202306-07.csv")
head(raw)
...
log <- read.csv("Raw Data/COMPASS_Synoptic_Varian_TGAS_QAQC_2023.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "Raw Data/COMPASS_Synoptic_Varian_TGAS_QAQC_2023.csv")
```
...
write.csv(final, "Processed Data/COMPASS_Synoptic_TGW_202306-07_Processed.csv")
